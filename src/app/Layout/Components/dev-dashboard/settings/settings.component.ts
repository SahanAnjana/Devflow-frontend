...
export class SettingsComponent implements OnInit {
  ...
  initializeForms(): void {
    ...
    this.securityForm = this.fb.group({
      ...
      sessionTimeout: [
        this.securitySettings.sessionTimeout,
  ...
  enable2FA(): void {
    this.modal.info({
      ...
      nzContent:
        'Two-factor authentication adds an extra layer of security to your account. You will need to use an authenticator app to generate codes when logging in.',
      nzOkText: 'Continue',
      nzOnOk: () => {
        // Implement 2FA setup logic here
        this.message.info(
          'Two-factor authentication setup will be implemented in the next version.'
        );
      },
    });
  }
