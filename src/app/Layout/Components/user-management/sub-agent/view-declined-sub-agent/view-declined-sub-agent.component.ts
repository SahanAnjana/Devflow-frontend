...
@Component({
  selector: 'app-view-declined-sub-agent',
  templateUrl: './view-declined-sub-agent.component.html',
  styleUrls: ['./view-declined-sub-agent.component.sass'],
})
export class ViewDeclinedSubAgentComponent {
  value?: string;
  ...
  getSelectedSubAgentData() {
    ...
    this.subAgentForm.patchValue({
      subAgentName: this.receivedSubAgentData.agentName,
      agentName: this.dataService.subAgentDeclinedData.agentName,
