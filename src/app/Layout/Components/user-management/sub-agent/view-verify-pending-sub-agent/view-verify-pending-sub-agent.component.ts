...
@Component({
  selector: 'app-view-verify-pending-sub-agent',
  templateUrl: './view-verify-pending-sub-agent.component.html',
  styleUrls: ['./view-verify-pending-sub-agent.component.sass'],
})
export class ViewVerifyPendingSubAgentComponent {
  value?: string;
