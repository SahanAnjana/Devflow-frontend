...
@Component({
  selector: 'app-corporate-customerdocuments',
  templateUrl: './corporate-customerdocuments.component.html',
  styleUrls: ['./corporate-customerdocuments.component.sass'],
})
export class CorporateCustomerdocumentsComponent {
